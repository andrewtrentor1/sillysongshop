...
MIDDLEWARE = [
    ...
    "orders.analytics_middleware.AnalyticsMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "orders.context_processors.analytics_settings",
            ],
        },
    },
]
...
if DEBUG:
    STRIPE_PUBLISHABLE_KEY = os.environ.get('STRIPE_DEV_PUBLISHABLE_KEY')
